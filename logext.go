...
const (
	...
	CYAN_BLUE  = "36m"
	WHITE      = "37m"
	BACK_RED   = "41m" //fatal default color
...
func (l *Logger) Output(reqId string, lvl int, calldepth int, s string) error {
	...
	l.levelStats[lvl]++
	l.buf.Reset()
	l.buf.WriteString(LOG_START)
	l.buf.WriteString(GetColor(lvl))
	l.formatHeader(&l.buf, now, file, line, lvl, reqId)
	l.buf.WriteString(s)
	l.buf.WriteString(LOG_END)
	l.buf.WriteByte('\n')
	_, err := l.out.Write(l.buf.Bytes())
	return err
}

func GetColor(lvl int) string {
	switch lvl {
	case Ldebug:
		return BLUE
	case Linfo:
...
func (l *Logger) Debug(v ...interface{}) {
	...
	l.Output("", Ldebug, 2, fmt.Sprint(v...))
}
...
func (l *Logger) Warn(v ...interface{}) { l.Output("", Lwarn, 2, fmt.Sprint(v...)) }
...
func (l *Logger) Error(v ...interface{}) { l.Output("", Lerror, 2, fmt.Sprint(v...)) }
...
func Warn(v ...interface{}) { Std.Output("", Lwarn, 2, fmt.Sprint(v...)) }
...
func Error(v ...interface{}) { Std.Output("", Lerror, 2, fmt.Sprint(v...)) }
